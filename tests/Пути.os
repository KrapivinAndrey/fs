...
Функция ПолучитьСписокТестов(Знач ЮнитТестирование) Экспорт
	...
	МассивТестов.Добавить("Тест_ОбъединитьПутиПравильноЛинукс");
...
Процедура Тест_ОбъединитьПутиПравильноЛинукс() Экспорт

	ПолныйПуть = ФС.ОбъединитьПути("/etc/my/test", "\images", "upload/pic.png");

	ПолныйПуть = СтрЗаменить(ПолныйПуть, ПолучитьРазделительПути(), "\");

	Ожидаем.Что(ПолныйПуть).Равно("\etc\my\test\images\upload\pic.png");
